...
// التوثيق على [[مستخدم:Kitrsjlhf/ArA.js]]

// بواسطة [[مستخدم:Kitrsjlhf]]
...
$(function() {
	...
	window.restorerSummary = window.restorerSummary ||
		...
		'استعادة النسخة $ID بواسطة [[Special:Contributions/$USER|$USER]] ([[User talk:$USER|نقاش]]) ([[ar:مستخدم:Kitrsjlhf/ArA.js|المُستَعيد]])';
